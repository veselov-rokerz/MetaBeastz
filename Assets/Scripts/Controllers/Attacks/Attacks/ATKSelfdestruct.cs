...
{
    public class ATKSelfdestruct : BaseATK
    {
                        ...
                        StartCoroutine(p.HitToTarget(p.PlayerActive, op.PlayerActive, response.Damage, () =>
                         {
                             ...
                             p.PlayerBenched.ForEach(e => e.CardDamage.HitDamage(p.PlayerActive, response.BenchDamage));

                             // We hit all the players benched monsters.
                             op.PlayerBenched.ForEach(e => e.CardDamage.HitDamage(p.PlayerActive, response.BenchDamage));
